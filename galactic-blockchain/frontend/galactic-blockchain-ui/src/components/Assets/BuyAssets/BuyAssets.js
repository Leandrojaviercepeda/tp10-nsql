        ...
        <Grid container justify="center" alignItems="center" spacing={1}>
          <Grid item xs={6}>
            <Paper elevation={2}  className={classes.paper}>
              <Typography color="textPrimary" align="center" variant="h5"> Comprar Activos </Typography>
            </Paper>
          </Grid>
          <Grid item xs={2}>
            <Paper elevation={2}  className={classes.paper}>
              <Typography color="textPrimary" align="center" variant="h5"> {`$ ${creditsCurrentUser ? creditsCurrentUser : ''}`} </Typography>
            </Paper>
          </Grid>
        </Grid>
